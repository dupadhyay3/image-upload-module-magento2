...
class Uploader
{
     ...
     * @var string
     */
    const IMAGE_TMP_PATH    = 'adminimageupload/tmp/images/image';
    /**
     * @var string
     */
    const IMAGE_PATH        = 'adminimageupload/images/image';
    /**
     * @var string
     */
    const FILE_TMP_PATH     = 'adminimageupload/tmp/images/file';
    /**
     * @var string
     */
    const FILE_PATH         = 'adminimageupload/images/file';
